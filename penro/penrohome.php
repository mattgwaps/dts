...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <link rel="stylesheet" href="/DENR/css/penro/penrohome.css">
...
<body background="/denr/img/ur.jpg">
  ...
  <div class="side-nav">
    ...
    <li class="nav-item " style="margin-top:20px;">
        <a class="nav-link active" href="penrohome.php">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="penroprocesstable.php">PROCESS</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="penrodocuments.php">DOCUMENTS</a>
      </li>
      <li class="nav-item">
