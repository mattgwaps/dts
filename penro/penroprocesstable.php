...
<html>
<head>
<title>127.0.0.1/prcess/table/<?php echo $_SESSION['username']; ?></title>  
<meta name="viewport" content="width=device-width, initial-scale=1">
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
  <!-- Bootstrap Bundle with Popper -->
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js"></script>
  <link rel="stylesheet" href="/DENR/css/penro/penroprocesstable.css">
  <script defer src="/DENR/js/penroprocesstable.js"></script>
...
<div style=""><input type="text" name="inputSearch"> <input type="submit" name="search" value="SEARCH"></div>
  ...
  <?php
          ...
          if($search === ""){
            ...
            echo "</tr></tbody>";
             ...
             $sql = "SELECT * FROM penro_table WHERE denrtransactionno LIKE ? OR denrofficeorigin LIKE ? OR denrdocumentstatus LIKE ? OR denrsubject LIKE ? ORDER BY denrtransactionno DESC";
  ...
  //Code for Displaying Records
    ...
    $sql = "SELECT * FROM penro_table ORDER BY id DESC";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_execute($stmt);
    $result = mysqli_stmt_get_result($stmt);
