...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
   ...
   <link rel="stylesheet" href="/DENR/css/unit/unittable.css">
...
<div style=""><input type="text" name="inputSearch"> <input type="submit" name="search" value="SEARCH"></div>
  ...
  <?php
          ...
          if($search === ""){
            ...
            echo "</tr></tbody>";
             ...
             $sql = "SELECT * FROM document_table WHERE (denrtransactionno LIKE ? OR denrofficeorigin LIKE ? OR denrdocumentstatus LIKE ? OR denrsubject LIKE ?) AND deptworkgroup = '". $_SESSION['workgroup'] ."' ORDER BY id DESC";
  ...
  //Code for Displaying Records
    ...
    $sql = "SELECT * FROM document_table WHERE deptworkgroup = '". $_SESSION['workgroup'] ."' ORDER BY id DESC";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_execute($stmt);
    $result = mysqli_stmt_get_result($stmt);
...
function updateRow(denrtransactionno){
    location.href = "unitdocumenttable.php?denrtransactionno=" + denrtransactionno;
    }
    //-------------------------------
