...
<head>
  ...
  <title>Side Navbar and Top Navbar with Bootstrap</title>
  <!-- Bootstrap CSS -->
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="/DENR/css/unit/unithome.css">
  ...
  <div class="side-nav">
    <ul class="nav flex-column">
      <li class="nav-item " style="margin-top:20px;">
        <a class="nav-link active" href="unithome.php">Home</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="unitprocesstable.php">Process</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="unittable.php">Documents</a>
      </li>
      <li class="nav-item">
