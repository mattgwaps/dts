...
<form action="return.php" method="POST">
  <div class="frontdeskdetails col-3">
    <h5>FRONTDESK</h5>
...
<div class="p-5 col-9"><!--Adjust here for Return Form --->
<h2>Return Form</h2>
...
<span>Action</span>
<textarea class="form-control form-control-sm" name="penroaction" type="text" placeholder="Action" readonly required><?php echo $row['penroaction'];?></textarea>
<span>Send To</span>
<select name="penrodepartment" id="penrodepartment" class="form-control form-control-sm" readonly required>
