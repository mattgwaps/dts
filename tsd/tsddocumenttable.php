...
<head>
  ...
  <link rel="stylesheet" href="/DENR/css/division/documenttable.css">
    ...
    <div class="row">
        ...
        <div class="col-6 mt-3">
            ...
            <div class="input-group mt-1">
                ...
                <span class="input-group-text">Workgroup</span>
                <input type="text" class="form-control" style="font-size:12px;" value="<?php echo htmlspecialchars($row['unitworkgroup']); ?>" readonly>
            </div>
            <div class="input-group mt-1">
                <span class="input-group-text">Date Processed</span>
