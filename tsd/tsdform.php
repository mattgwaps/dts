...
if (isset($_GET['denrtransactionno'])) {
    ...
    $sql = "SELECT * FROM tsd_table WHERE denrtransactionno = ?";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        header("Location:tsdprocesstable.php");
    ...
    <img src="/denr/img/logo.ico" alt="logo" style="width:3rem"> <a class="navbar-brand">PENRO LEYTE</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/denr/tsd/tsdhome.php">BACK</a>
          </li>
        </ul>
      </div>
    </div>
...
<div class="formbody">
          <form action="tsdformupdate.php" method="POST" onsubmit="return validateCheckboxes()">
...
<hr>
          ...
          <div class="penroform">
            <h2 style="text-align:center;">TSD FORM DETAILS</h2>
          <div class="formgroup">
            ...
            <div class="formgroup">
              ...
              <span>Action:</span>
                ...
                <input type="checkbox" id="cbitem9" name="deptaction[]" value="">
                ...
                <div class="formgroup">
                    <div class="formgroupitem">
                    <span>WorkGroup</span>
                        <select name="deptworkgroup" id="denrformworkgroupTSD" required>
                        <option value="" selected>Select TSD</option>
                            <option value="CDS">CDS</option>
                            <option value="CBFM">CBFM</option>
                           <option value="WATERSHED">WATERSHED</option>
                            <option value="RWRC">RWRC</option>
                            <option value="MONITORING AND ENFORCEMENT SECTION">MONITORING AND ENFORCEMENT SECTION</option>
                            <option value="LAWIN COORDINATOR">LAWIN COORDINATOR</option>
                            <option value="REGULATION AND PERMITTING UNIT">REGULATION AND PERMITTING UNIT</option>
                    ...
                    <span>To:</span>
                        ...
                        <option value="" selected>Select Here</option>
                                <optgroup label="CDS">
                                <option value="Raquel Dabuet">Raquel Dabuet</option>
                                <option value="Jonel Gula">Jonel Gula</option>
                                ...
                                <optgroup label="Watershed">
                                <option value="Raquel Dabuet">Raquel Dabuet</option>
                                <option value="Paulino Masan">Paulino Masan</option>
                                </optgroup>

                                <optgroup label="RWRC">
                                <option value="Rodrigo Marquez">Rodrigo Marquez</option>
                                </optgroup>

                                <optgroup label="Monitoring and Enforcement Section">
                                <option value="Michael Macalalag">Michael Macalalag</option>
                                </optgroup>

                                
                                <optgroup label="LAWIN Coordinator">
                                <option value="Rihanna Libot">Rihanna Libot</option>
                                </optgroup>

                                <optgroup label="Regulation and Permitting Unit">
                                <option value="Evangeline Lopez">Evangeline Lopez</option>
                                </optgroup>

                                <optgroup label="NGP">
                                <option value="Winzel Nuñez">Winzel Nuñez</option>
                                </optgroup>

                                <optgroup label="MGB">
                                <option value="Ericha Sayon">Ericha Sayon</option>
                                </optgroup>
